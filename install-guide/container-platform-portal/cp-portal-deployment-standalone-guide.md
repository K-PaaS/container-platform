...
|**HOST_CLUSTER_IAAS_TYPE**|Kubernetes Cluster IaaS 환경 입력|[1] AWS [2] OPENSTACK [3] NAVER [4] NHN [5] KT |
...
serviceaccount "cp-cluster-admin" deleted
clusterrolebinding.rbac.authorization.k8s.io "cp-cluster-admin" deleted
release "cp-vault" uninstalled
...
release "cp-portal-resource" uninstalled
